...
•	thal (type: categorical): results of [thallium stress test](https://www.ucsfbenioffchildrens.org/medical-tests/007201) measuring blood flow to the heart both during rest and during activity, with possible values normal (3), fixed defect (6), reversible defect (7) <br/>
